...
sentryTest('should report a transaction in an envelope', async ({ getLocalTestPath, page, isTracingCapableBundle }) => {
...
sentryTest(
  'should report finished spans as children of the root transaction',
