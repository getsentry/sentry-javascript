...
sentryTest('should capture FP vital.', async ({ browserName, getLocalTestPath, page, isTracingCapableBundle }) => {
...
sentryTest('should capture FCP vital.', async ({ getLocalTestPath, page, isTracingCapableBundle }) => {
