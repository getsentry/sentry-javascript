...
The official Sentry SDK for monitoring Angular applications.

## Documentation

- [Getting started](https://docs.sentry.io/platforms/javascript/guides/angular/)
- [Configuration](https://docs.sentry.io/platforms/javascript/guides/angular/configuration/)
- [Angular-specific features](https://docs.sentry.io/platforms/javascript/guides/angular/features/)
