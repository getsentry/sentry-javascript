...
declare namespace Deno {
   ...
   * @category File System
   */
  export class FsFile implements Reader, ReaderSync, Writer, WriterSync, Seeker, SeekerSync, Closer {
   ...
   * @category HTTP Server
   */
  export function serve(options: ServeOptions | ServeTlsOptions, handler: ServeHandler): Server;
   ...
   * @category HTTP Server
   */
  export function serve(options: ServeInit & (ServeOptions | ServeTlsOptions)): Server;
}
...
declare namespace Deno {
   ...
   * @category Network
   */
  export function startTls(conn: Conn, options?: StartTlsOptions): Promise<TlsConn>;
