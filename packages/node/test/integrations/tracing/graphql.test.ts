import { GraphQLInstrumentation } from '../../../src/integrations/tracing/graphql/vendored/instrumentation';
...
vi.mock('../../../src/integrations/tracing/graphql/vendored/instrumentation');
