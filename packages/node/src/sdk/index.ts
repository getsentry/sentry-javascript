...
function _init(
  ...
  const defaultIntegrations = getDefaultIntegrationsImpl(optionsWithTracesSampleRate);

  const clientOptions = getClientOptions<NodeOptions, NodeClientOptions>(options, {
