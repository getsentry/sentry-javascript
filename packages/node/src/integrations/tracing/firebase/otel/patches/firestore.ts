// Use OpenTelemetry Attributes type which is equivalent to SpanAttributes
 ...
 */
function setPortAndAddress(hostString: string, server: ServerInfo, attributes: Attributes): void {
  if (!hostString) {
    return;
  }
