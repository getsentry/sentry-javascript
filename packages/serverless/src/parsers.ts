 ...
 * @hidden
 */
export function parseStack(stack: stacktrace.StackFrame[], options?: ServerlessOptions): PromiseLike<StackFrame[]> {
 ...
 * @hidden
 */
export function getExceptionFromError(error: Error, options?: ServerlessOptions): PromiseLike<Exception> {
 ...
 * @hidden
 */
export function parseError(error: ExtendedError, options?: ServerlessOptions): PromiseLike<Event> {
