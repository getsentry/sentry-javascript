  ...
  it('should parse SecurityError', () => {
    const SECURITY_ERROR = {
      ...
      stack:
        ...
        '   at <object>.actions.play(../node_modules/@sentry/rrweb/es/rrweb/packages/rrweb/src/replay/machine.js:132:17)\n' +
        '   at <anonymous>(../node_modules/@sentry/rrweb/es/rrweb/ext/@xstate/fsm/es/index.js:15:2595)\n' +
    ...
    expect(ex).toEqual({
      ...
      stacktrace: {
        frames: [
          ...
          {
            filename: '../node_modules/@sentry/rrweb/es/rrweb/packages/rrweb/src/replay/index.js',
          ...
          {
            filename: '../node_modules/@sentry/rrweb/es/rrweb/ext/@xstate/fsm/es/index.js',
            function: 'c.send',
            in_app: true,
            lineno: 15,
            colno: 2741,
          ...
          {
            filename: '../node_modules/@sentry/rrweb/es/rrweb/packages/rrweb/src/replay/machine.js',
