...
const urlPatterns = [
  [
      ...
      'http://localhost:3001/_next/static/chunks/app/%5Blocale%5D/sentery-example-page/%28default%29/sub/page-3d428c1ba734e10f.js',1,126
  ],
  ...
  ['http://example.com/path/to/[[locale]]/resource:1:126', 'http://example.com/path/to/%5B%5Blocale%5D%5D/resource',1,126],
  ['http://example.com/path/to/[[...locale]]/resource:1:126', 'http://example.com/path/to/%5B%5B...locale%5D%5D/resource',1,126],
  ['http://example.com/path/[[locale]]/to/[[locale]]/resource:1:126', 'http://example.com/path/%5B%5Blocale%5D%5D/to/%5B%5Blocale%5D%5D/resource',1,126],
  ...
  ['https://example.com/path/to/[[locale]]/resource:1:126', 'https://example.com/path/to/%5B%5Blocale%5D%5D/resource',1,126],
  ['https://example.com/path/to/[[...locale]]/resource:1:126', 'https://example.com/path/to/%5B%5B...locale%5D%5D/resource',1,126],
  ['https://example.com/path/[[locale]]/to/[[locale]]/resource:1:126', 'https://example.com/path/%5B%5Blocale%5D%5D/to/%5B%5Blocale%5D%5D/resource',1,126],
  ...
  ['http://example.com/path/to/[[locale]]/resource:1:126)', 'http://example.com/path/to/%5B%5Blocale%5D%5D/resource',1,126],
  ['http://example.com/path/to/resource[[locale]]:1:126', 'http://example.com/path/to/resource%5B%5Blocale%5D%5D',1,126],
  ['http://example.com/path/to/resource[[...locale]]:1:126', 'http://example.com/path/to/resource%5B%5B...locale%5D%5D',1,126],
  ['https://example.com/path/to/resource[[locale]]:1:126', 'https://example.com/path/to/resource%5B%5Blocale%5D%5D',1,126],
  ['http://example.com/path/to/(resource)/[[locale]]:1:126', 'http://example.com/path/to/%28resource%29/%5B%5Blocale%5D%5D',1,126],
  ['https://example.com/(path)/to/resource[[locale]]:1:126', 'https://example.com/%28path%29/to/resource%5B%5Blocale%5D%5D',1,126],
  ['http://192.168.1.1/path/to/[[locale]]/resource:1:126', 'http://192.168.1.1/path/to/%5B%5Blocale%5D%5D/resource',1,126],
  ['http://example.com/path/to/[[locale]]/resource#anchor:1:126', 'http://example.com/path/to/%5B%5Blocale%5D%5D/resource#anchor',1,126],
]
