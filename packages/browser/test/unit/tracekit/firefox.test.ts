        ...
        frames: [
          {
            ...
            abs_path: 'http://127.0.0.1:8000/js/file.js',
            function: '?',
            lineno: 24,
            in_app: true,
          },
          ...
          {
            filename: 'http://127.0.0.1:8000/js/stacktrace.js',
            abs_path: 'http://127.0.0.1:8000/js/stacktrace.js',
    ...
    expect(ex).toEqual({
      ...
      stacktrace: {
        frames: [
          ...
          {
            filename: 'file:///G:/js/stacktrace.js',
            abs_path: 'file:///G:/js/stacktrace.js',
            function: 'printStackTrace',
            lineno: 18,
            in_app: true,
          },
        ...
        frames: [
          {
            ...
            abs_path: 'file:///path/to/index.html',
            function: '?',
            lineno: 23,
            colno: 1,
            in_app: true,
    ...
    expect(ex).toEqual({
      ...
      stacktrace: {
        frames: [
          {
            filename: 'resource://path/data/content/bundle.js',
            abs_path: 'resource://path/data/content/bundle.js',
            function: 'wrapped',
            lineno: 7270,
            colno: 25,
            in_app: true,
          },
          {
            ...
            abs_path: 'resource://path/data/content/vendor.bundle.js',
