    ...
    expect(ex).toEqual({
      ...
      stacktrace: {
        frames: [
          ...
          { filename: 'native', function: '_receiveSignal' },
          { filename: 'native', function: 'touchableHandleResponderRelease' },
          { filename: 'native', function: 'onResponderRelease' },
          ...
          { filename: 'native', function: 'forEach' },
