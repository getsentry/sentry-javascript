...
describe('Tracekit - React Native Tests', () => {
  ...
  it('should parse exceptions for react-native Expo bundles', () => {
    ...
    expect(stacktrace).toEqual({
      ...
      stacktrace: {
        frames: [
          { filename: '[native code]', abs_path: '[native code]', function: 'forEach', in_app: true },
          {
            filename:
      ...
      stacktrace: {
        frames: [
          ...
          },
          {
            ...
            abs_path: '/home/username/sample-workspace/sampleapp.collect.react/src/components/GpsMonitorScene.js',
            function: 'render',
            lineno: 78,
            colno: 24,
            in_app: true,
    ...
    expect(ex).toEqual({
      ...
      stacktrace: {
        frames: [
          ...
          { filename: 'native', abs_path: 'native', function: 'apply', in_app: true },
          {
            filename: 'index.android.bundle',
            abs_path: 'index.android.bundle',
            function: 'k',
          ...
          { filename: 'native', abs_path: 'native', function: 'apply', in_app: true },
          { filename: 'native', abs_path: 'native', function: 'onResponderRelease', in_app: true },
          { filename: 'native', abs_path: 'native', function: 'touchableHandleResponderRelease', in_app: true },
          { filename: 'native', abs_path: 'native', function: '_receiveSignal', in_app: true },
          {
            filename: 'index.android.bundle',
            abs_path: 'index.android.bundle',
            function: '_performSideEffectsForTransition',
