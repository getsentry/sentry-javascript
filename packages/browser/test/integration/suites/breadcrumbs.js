describe('breadcrumbs', () => {
  it(optional('should record an XMLHttpRequest with a handler', IS_LOADER), () =>
  ...
  it(optional('should record an XMLHttpRequest with a handler attached after send was called', IS_LOADER), () =>
    runInSandbox(sandbox, { manual: true }, () => {
      var xhr = new XMLHttpRequest();
      xhr.open('GET', '/base/subjects/example.json');
      xhr.send();
  ...
  it(optional('should record an XMLHttpRequest without any handlers set', IS_LOADER), () =>
    runInSandbox(sandbox, { manual: true }, () => {
      var xhr = new XMLHttpRequest();
      xhr.open('get', '/base/subjects/example.json');
      xhr.send();
  ...
  it(optional('should give access to request body for XMLHttpRequest POST requests', IS_LOADER), () =>
    runInSandbox(sandbox, { manual: true }, () => {
      var xhr = new XMLHttpRequest();
  ...
  it('should record a fetch request', () =>
    runInSandbox(sandbox, { manual: true }, () => {
  ...
  it('should record a fetch request with Request obj instead of URL string', () =>
    runInSandbox(sandbox, { manual: true }, () => {
  ...
  it('should record a fetch request with an arbitrary type argument', () =>
    runInSandbox(sandbox, { manual: true }, () => {
      fetch(123)
        .then(
          () => {
  ...
  it('should provide a hint for dom events that includes event name and event itself', () =>
  ...
  it('should not fail with click or keypress handler with no callback', () =>
    runInSandbox(sandbox, () => {
      var input = document.getElementsByTagName('input')[0];
  ...
  it('should not fail with custom event', () =>
    runInSandbox(sandbox, () => {
      var input = document.getElementsByTagName('input')[0];
      input.addEventListener('build', evt => {
        evt.stopPropagation();
      });
  ...
  it('should not fail with custom event and handler with no callback', () =>
    runInSandbox(sandbox, () => {
      var input = document.getElementsByTagName('input')[0];
  ...
  it('should record a mouse click on element WITH click handler present', () =>
    runInSandbox(sandbox, () => {
  ...
  it('should record a mouse click on element WITHOUT click handler present', () =>
    runInSandbox(sandbox, () => {
      // click <input/>
      var click = new MouseEvent('click');
      var input = document.getElementsByTagName('input')[0];
  ...
  it('should only record a SINGLE mouse click for a tree of elements with event listeners', () =>
    runInSandbox(sandbox, () => {
      var clickHandler = () => {};
  ...
  it('should bail out if accessing the `target` property of an event throws an exception', () => {
  ...
  it('should record consecutive keypress events into a single "input" breadcrumb', () =>
    runInSandbox(sandbox, () => {
  ...
  it('should correctly capture multiple consecutive breadcrumbs if they are of different type', () =>
    runInSandbox(sandbox, () => {
      var input = document.getElementsByTagName('input')[0];
  ...
  it('should debounce multiple consecutive identical breadcrumbs but allow for switching to a different type', () =>
    runInSandbox(sandbox, () => {
      var input = document.getElementsByTagName('input')[0];
  ...
  it('should debounce multiple consecutive identical breadcrumbs but allow for switching to a different target', () =>
    runInSandbox(sandbox, () => {
  ...
  it(optional('should flush keypress breadcrumbs when an error is thrown', IS_LOADER), () =>
    runInSandbox(sandbox, () => {
      // keypress <input/>
      var keypress = new KeyboardEvent('keypress');
      var input = document.getElementsByTagName('input')[0];
  ...
  it('should flush keypress breadcrumb when input event occurs immediately after', () =>
    runInSandbox(sandbox, () => {
      // 1st keypress <input/>
      var keypress1 = new KeyboardEvent('keypress');
      // click <input/>
  ...
  it('should record consecutive keypress events in a contenteditable into a single "input" breadcrumb', () =>
    runInSandbox(sandbox, () => {
      // keypress <input/> twice
      var keypress1 = new KeyboardEvent('keypress');
      var keypress2 = new KeyboardEvent('keypress');
  ...
  it('should record click events that were handled using an object with handleEvent property and call original callback', () =>
    runInSandbox(sandbox, () => {
  ...
  it('should record keypress events that were handled using an object with handleEvent property and call original callback', () =>
    runInSandbox(sandbox, () => {
      window.handleEventCalled = false;
  ...
  it('should remove breadcrumb instrumentation when all event listeners are detached', () =>
    runInSandbox(sandbox, () => {
      var input = document.getElementsByTagName('input')[0];

      var clickHandler = () => {};
      var otherClickHandler = () => {};
      input.addEventListener('click', clickHandler);
  ...
  it(optional('should record history.[pushState|replaceState] changes as navigation breadcrumbs', IS_LOADER), () =>
    runInSandbox(sandbox, () => {
  ...
  it(optional('should preserve native code detection compatibility', IS_LOADER), () =>
    runInSandbox(sandbox, { manual: true }, () => {
      window.resolveTest();
    }).then(() => {
      if (IS_LOADER) {
  ...
  it('should capture console breadcrumbs', () =>
    runInSandbox(sandbox, { manual: true }, () => {
