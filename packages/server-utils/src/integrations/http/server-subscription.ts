...
import { getClient, getCurrentScope, getIsolationScope, withIsolationScope } from '@sentry/core';
import { hasSpansEnabled } from '@sentry/core';
import { headersToDict, httpHeadersToSpanAttributes, httpRequestToRequestData } from '@sentry/core';
import { patchRequestToCaptureBody } from './patch-request-to-capture-body';
import { parseStringToURLObject, stripUrlQueryAndFragment } from '@sentry/core';
...
import { getSpanStatusFromHttpCode, SPAN_STATUS_ERROR, startSpanManual } from '@sentry/core';
import {
  SEMANTIC_ATTRIBUTE_SENTRY_OP,
  SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN,
  SEMANTIC_ATTRIBUTE_SENTRY_SOURCE,
} from '@sentry/core';
import { _INTERNAL_safeMathRandom as safeMathRandom } from '@sentry/core';
