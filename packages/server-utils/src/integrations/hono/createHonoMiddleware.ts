 ...
 * deduplicated behind the auto-instrumentation (which is registered first, in the `Hono`
 * constructor): the deduplicated middleware records its callback on the request scope, and the
