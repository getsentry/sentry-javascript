...
import { subscribeGraphqlDiagnosticChannels } from './graphql-dc-subscriber';

const _graphqlChannelIntegration = (() => {
  return {
    name: 'Graphql',
    setupOnce() {
      ...
      void Promise.resolve().then(() => subscribeGraphqlDiagnosticChannels(dc.tracingChannel));
    },
  };
