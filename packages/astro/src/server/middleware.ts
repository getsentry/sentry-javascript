...
import type { APIContext, MiddlewareHandler, RoutePart } from 'astro';
...
function getParametrizedRoute(ctx: Parameters<MiddlewareHandler>[0] & { routePattern?: string }): string | undefined {
  try {
