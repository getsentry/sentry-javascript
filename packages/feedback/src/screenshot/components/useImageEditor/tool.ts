...
class Drawing implements IDrawing {
  ...
  protected startPoint: IPoint = { x: 0, y: 0 };
  protected endPoint: IPoint = { x: 0, y: 0 };
  ...
  isInPath(context: CanvasRenderingContext2D | null, point: IPoint) {
  ...
  private withTransform<T>(context: CanvasRenderingContext2D | null, callback: () => T): T {
  ...
  drawToCanvas(context: CanvasRenderingContext2D | null) {
