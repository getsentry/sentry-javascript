  ...
  describe('getLargestContentfulPaint', () => {
    it('works with an LCP metric', async () => {
      ...
      expect(event).toEqual({
        ...
        data: { value: 5108.299, rating: 'good', size: 5108.299, nodeIds: [], attributions: undefined },
      });
    });
  });
  ...
  describe('getCumulativeLayoutShift', () => {
    it('works with a CLS metric', async () => {
      ...
      expect(event).toEqual({
        ...
        data: { value: 5108.299, size: 5108.299, rating: 'good', nodeIds: [], attributions: undefined },
      });
    });
  });
