...
describe('getHttpSpanDetailsFromUrlObject', () => {
  ...
  it('handles absolute URL object', () => {
    ...
    expect(attributes).toEqual({
      ...
      'http.url': 'https://example.com/api/users?q=test#section',
  ...
  it('handles URL with port', () => {
    ...
    expect(attributes).toEqual({
      ...
      'http.url': 'https://example.com:8080/api/users',
      'server.address': 'example.com',
      'url.scheme': 'https:',
      'url.port': '8080',
    });
  ...
  it('handles URL with non-standard port and request method', () => {
    ...
    expect(attributes).toEqual({
      ...
      'http.url': 'https://example.com:3000/api/users',
      'server.address': 'example.com',
      'url.scheme': 'https:',
      'url.port': '3000',
  ...
  it('handles URL with route name and request method', () => {
    ...
    expect(attributes).toEqual({
      ...
      'http.url': 'https://example.com/api/users/123',
      'server.address': 'example.com',
      'url.scheme': 'https:',
      'http.route': '/api/users/:id',
  ...
  it('handles URL with query params and route name', () => {
    ...
    expect(attributes).toEqual({
      ...
      'http.url': 'https://example.com/api/search?q=test&page=1',
      'server.address': 'example.com',
      'url.scheme': 'https:',
  ...
  it('handles URL with fragment and route name', () => {
    ...
    expect(attributes).toEqual({
      ...
      'http.url': 'https://example.com/api/docs#section-1',
      'server.address': 'example.com',
      'url.scheme': 'https:',
      'http.route': '/api/docs',
    });
  ...
  it('handles URL with auth credentials', () => {
    ...
    expect(attributes).toEqual({
      ...
      'http.url': 'https://user:pass@example.com/api/users',
      'server.address': 'example.com',
      'url.scheme': 'https:',
    });
  });
  ...
  it('handles URL with IPv4 address', () => {
    ...
    expect(attributes).toEqual({
      ...
      'http.url': 'https://192.168.1.1:8080/api/users',
  ...
  it('handles URL with IPv6 address', () => {
    ...
    expect(attributes).toEqual({
      ...
      'http.url': 'https://[2001:db8::1]:8080/api/users',
