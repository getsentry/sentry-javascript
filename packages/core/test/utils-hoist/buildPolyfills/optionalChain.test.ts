// TODO(v9): Remove this test

import { shim as arrayFlatShim } from 'array.prototype.flat';

import { _optionalChain } from '../../../src/utils-hoist/buildPolyfills';
import type { GenericFunction, GenericObject, Value } from '../../../src/utils-hoist/buildPolyfills/types';
