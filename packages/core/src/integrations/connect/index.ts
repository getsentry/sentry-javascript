...
export type ConnectModuleExport = ConnectModule | {
 ...
 * ```
 */
export function patchConnectModule(connectModule: ConnectModuleExport, options?: ConnectIntegrationOptions): ConnectModule {
