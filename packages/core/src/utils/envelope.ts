...
// Map of envelope item types to data categories where the category differs from the type name.
// Types that map to themselves (session, attachment, transaction, profile, feedback, span, metric) use fallback.
