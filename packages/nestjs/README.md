...
- [Getting started](https://docs.sentry.io/platforms/javascript/guides/nestjs/)
- [Configuration](https://docs.sentry.io/platforms/javascript/guides/nestjs/configuration/)
- [NestJS-specific features](https://docs.sentry.io/platforms/javascript/guides/nestjs/features/)
