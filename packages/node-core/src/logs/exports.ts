...
import type { CaptureLogArgs, CaptureLogMetadata } from './capture';
 ...
 * ```
 */
export function info(message: ParameterizedString, attributes?: Log['attributes'], metadata?: CaptureLogMetadata): void;
/**
 * @summary Capture a log with the `info` level. Requires the `enableLogs` option to be enabled.
 *
 * You can either pass a message and attributes or a message template, params and attributes.
 ...
 * ```
 */
export function warn(message: ParameterizedString, attributes?: Log['attributes'], metadata?: CaptureLogMetadata): void;
/**
 * @summary Capture a log with the `warn` level. Requires the `enableLogs` option to be enabled.
 *
 * You can either pass a message and attributes or a message template, params and attributes.
