 ...
 *
 * This wrapper:
 * - Captures errors from RSC payload generation
 * - Traces server function execution via `loadServerAction`
 * - Creates spans for RSC rendering operations
 * - Enhances the `onError` callback for comprehensive error capture
 *
 ...
 *   return sentryMatchRSCServerRequest({
 *     request,
 *     routes: routes(),
