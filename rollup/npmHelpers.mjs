...
const packageDotJSON = JSON.parse(fs.readFileSync(packagePath, 'utf8'));
...
export function makeBaseNPMConfig(options = {}) {
  ...
  const defaultBaseConfig = {
    ...
    // Rollup will throw an error instead of showing a warning when a deprecated feature is used.
