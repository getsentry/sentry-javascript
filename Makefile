...
post-commit:
	...
	s3cmd put --acl-public --guess-mime-type --add-header "Cache-control: max-age=600" dist/raven.js s3://getsentry-cdn/build/${BRANCH}/raven.js
	s3cmd put --acl-public --guess-mime-type --add-header "Cache-control: max-age=600" dist/raven.min.js s3://getsentry-cdn/build/${BRANCH}/raven.min.js
