...
- The `samplingContext.transactionContext` object in the `tracesSampler` and `profileSampler` has been removed. All object attributes are available in the top-level of `samplingContext`.
