          ...
          (function(c) {
            ...
            var g = a(6),
              ...
              H =
                'undefined' != typeof window
                  ? window
                  : 'undefined' != typeof c ? c : 'undefined' != typeof self ? self : {},
              I = H.document,
              J = H.navigator;
            (f.prototype = {
              VERSION: '3.19.0',
              ...
              config: function(a, b) {
                var c = this;
                if (c.g)
                  return this.y('error', 'Error: Raven has already been configured'), c;
                if (!a) return c;
                var d = c.k;
                b &&
                  r(b, function(a, b) {
                  ...
                  (d.ignoreErrors = w(d.ignoreErrors)),
                  (d.ignoreUrls = !!d.ignoreUrls.length && w(d.ignoreUrls)),
                  (d.whitelistUrls = !!d.whitelistUrls.length && w(d.whitelistUrls)),
                  (d.includePaths = w(d.includePaths)),
                  (d.maxBreadcrumbs = Math.max(
                    0,
                    Math.min(d.maxBreadcrumbs || 100, 100)
                  ));
                var e = {xhr: !0, console: !0, dom: !0, location: !0},
                  f = d.autoBreadcrumbs;
              ...
              captureException: function(a, b) {
                ...
                if ((c && d) || e)
                  return this.captureMessage(
                    a,
                    s({trimHeadFrames: 1, stacktrace: !0}, b)
                  );
                ...
                if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(a)) {
                  ...
                  if (
                    ...
                    if (this.k.stacktrace || (b && b.stacktrace)) {
                      b = s(
                        {fingerprint: a, trimHeadFrames: (b.trimHeadFrames || 0) + 1},
                        b
                      );
                      var j = this.O(f, b);
              ...
              R: function(a, b) {
                ...
                if (this.b) {
                  (b = b || {}),
                    ...
                    I.createEvent
                      ? ((c = I.createEvent('HTMLEvents')), c.initEvent(a, !0, !0))
                      : ((c = I.createEventObject()), (c.eventType = a));
              ...
              B: function() {
                    ...
                    function(a) {
                      return function(c, d) {
                        return (
                          p(d) &&
                            d.indexOf(b.h) === -1 &&
                            (this.W = {method: c, url: d, status_code: null}),
                    ...
                    D(
                      ...
                      function(c) {
                        return function(d) {
                          ...
                          for (
                            var f = this, g = ['onload', 'onerror', 'onprogress'], h = 0;
                            h < g.length;
                            h++
                          )
                            a(g[h], f);
                          return (
                            'onreadystatechange' in f && o(f.onreadystatechange)
                              ? D(f, 'onreadystatechange', function(a) {
                ...
                c.xhr &&
                  ...
                  D(
                    ...
                    function(a) {
                      return function(c, d) {
                        ...
                        'string' == typeof h
                          ? (g = h)
                          : 'Request' in H && h instanceof H.Request
                            ? ((g = h.url), h.method && (i = h.method))
                            : (g = '' + h),
                          e[1] && e[1].method && (i = e[1].method);
                        var j = {method: i, url: g, status_code: null};
                        return (
                          b.captureBreadcrumb({type: 'http', category: 'fetch', data: j}),
                  ...
                  c.dom &&
                    this.b &&
                    (I.addEventListener
                      ? (I.addEventListener('click', b.S('click'), !1),
                        I.addEventListener('keypress', b.U(), !1))
                      : (I.attachEvent('onclick', b.S('click')),
                        I.attachEvent('onkeypress', b.U())));
                var f = H.chrome,
              ...
              N: function(a, b) {
                var c = this.O(a, b);
                this.R('handle', {stackInfo: a, options: b}),
              ...
              Y: function(a, b) {
                ...
                return (
                  a.url || (c.filename = b),
                  (c.in_app = !(
                    (this.k.includePaths.test && !this.k.includePaths.test(c.filename)) ||
              ...
              X: function(a, b, c, d, e, f) {
                ...
                if (
                  ...
                  (!this.k.ignoreErrors.test(b) && !this.k.ignoreErrors.test(g))
                ) {
                  var h;
                  if (
                    (e && e.length
                      ? ((c = e[0].filename || c), e.reverse(), (h = {frames: e}))
                      : c && (h = {frames: [{filename: c, lineno: d, in_app: !0}]}),
                    (!this.k.ignoreUrls.test || !this.k.ignoreUrls.test(c)) &&
                      (!this.k.whitelistUrls.test || this.k.whitelistUrls.test(c)))
                  ) {
                    var i = s(
                      {
                        exception: {values: [{type: a, value: b, stacktrace: h}]},
                        culprit: c
                      },
                      f
                    );
              ...
              Z: function(a) {
                ...
                return (
                  d &&
                    (d.url && (d.url = t(d.url, this.k.maxUrlLength)),
                    d.Referer && (d.Referer = t(d.Referer, this.k.maxUrlLength))),
              ...
              $: function(a) {
                for (
                  ...
                  if (
                    ((c = a.values[f]),
                    c.hasOwnProperty('data') && l(c.data) && !u(c.data))
                  ) {
                    d = s({}, c.data);
              ...
              _: function() {
                if (this.c || this.b) {
                  ...
                  return (
                    this.c &&
                      J.userAgent &&
                      (a.headers = {'User-Agent': navigator.userAgent}),
                    this.b &&
                      (I.location && I.location.href && (a.url = I.location.href),
                      I.referrer &&
                        (a.headers || (a.headers = {}),
                        (a.headers.Referer = I.referrer))),
                    a
                  );
                }
              },
              ...
              da: function(a) {
                var b = this.e;
                return (
                  !(!b || a.message !== b.message || a.culprit !== b.culprit) &&
                  (a.stacktrace || b.stacktrace
                    ? B(a.stacktrace, b.stacktrace)
                    : (!a.exception && !b.exception) || A(a.exception, b.exception))
                );
              },
              ea: function(a) {
                if (!this.ca()) {
              ...
              P: function(a) {
                ...
                if (
                  ...
                  (a = s(c, a)),
                  (a.tags = s(s({}, this.j.tags), a.tags)),
                  (a.extra = s(s({}, this.j.extra), a.extra)),
                  (a.extra['session:duration'] = d() - this.r),
                  this.t &&
                    this.t.length > 0 &&
                    (a.breadcrumbs = {values: [].slice.call(this.t, 0)}),
                  q(a.tags) && delete a.tags,
                  ...
                  o(b.dataCallback) && (a = b.dataCallback(a) || a),
                  a && !q(a) && (!o(b.shouldSendCallback) || b.shouldSendCallback(a)))
                )
                  return this.ca()
                    ? void this.y('warn', 'Raven dropped error due to backoff: ', a)
                    : void ('number' == typeof b.sampleRate
                        ? Math.random() < b.sampleRate && this.fa(a)
                        : this.fa(a));
              },
              ga: function() {
                return y();
              ...
              fa: function(a, b) {
                var c = this,
                  d = this.k;
                if (this.isSetup()) {
                  if (((a = this.Z(a)), !this.k.allowDuplicates && this.da(a)))
      ...
      5: [
        function(a, b, c) {
          (function(a) {
            ...
            function l(a, b) {
              var c, d;
              if (f(a.length)) for (c in a) p(a, c) && b.call(null, c, a[c]);
            ...
            function u(a) {
              for (
                var b, c = 5, d = 80, e = [], f = 0, g = 0, h = ' > ', i = h.length;
                a &&
                f++ < c &&
                ((b = v(a)),
                !('html' === b || (f > 1 && g + e.length * i + b.length >= d)));
            ...
            function x(a, b) {
              return (
                ...
                ((a = a.values[0]),
                (b = b.values[0]),
                a.type === b.type && a.value === b.value && y(a.stacktrace, b.stacktrace))
              );
            }
            function y(a, b) {
              if (w(a, b)) return !1;
            ...
            (f.report = (function() {
              ...
              function l(a, b, c, g, h) {
                ...
                if (v)
                  ...
                  (n.func = i),
                    (l = {name: p, message: r, url: d(), stack: [n]}),
                    k(l, !0);
                }
              ...
              (f.computeStackTrace = (function() {
                  ...
                  if ('undefined' != typeof a.stack && a.stack) {
                    for (
                      var b,
                        ...
                        g = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i,
                        h = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i,
                        j = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
                        k = /\((\S*)(?::(\d+))(?::(\d+))\)/,
                        l = a.stack.split('\n'),
                        m = [],
                        n = (/^(.*) is undefined$/.exec(a.message), 0),
                        o = l.length;
                      n < o;
                      ++n
                    ) {
                    ...
                    return m.length
                      ? {name: a.name, message: a.message, url: d(), stack: m}
                      : null;
                  }
                }
                function b(a, b, c, d) {
                ...
                function c(a, g) {
                  for (
                    var h,
                      j,
                      k = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i,
                      l = [],
                      m = {},
                      n = !1,
                      o = c.caller;
                    ...
                    if (o !== e && o !== f.report) {
                      if (
                        ((j = {url: null, func: i, line: null, column: null}),
                        o.name
                          ? (j.func = o.name)
                          : (h = k.exec(o.toString())) && (j.func = h[1]),
                        'undefined' == typeof j.func)
                      )
                        try {
                ...
                return (
                  (e.augmentStackTraceWithInitialElement = b),
