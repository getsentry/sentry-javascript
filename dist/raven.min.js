      ...
      3: [
        function(a, b, c) {
          (function(c) {
            ...
            function k(a, b) {
              var c, d;
              if (g(a.length)) for (c in a) o(a, c) && b.call(null, c, a[c]);
            ...
            f.prototype = {
              ...
              wrap: function(a, b, c) {
                ...
                var e = this;
                if (g(b) && !h(a)) return a;
                if ((h(a) && ((b = a), (a = void 0)), !h(b))) return b;
                try {
                  if (b.J) return b;
                  if (b.K) return b.K;
                } catch (f) {
              ...
              captureException: function(a, b) {
                if (!D(a))
                  return this.captureMessage(
                    a,
                    l({trimHeadFrames: 1, stacktrace: !0}, b)
                  );
                this.d = a;
                try {
              ...
              showReportDialog: function(a) {
                if (J) {
                  ...
                  if (!b) throw new B('Missing eventId');
                  var c = a.dsn || this.E;
                  if (!c) throw new B('Missing DSN');
              ...
              R: function(a, b) {
                ...
                if (this.b) {
                  (b = b || {}),
                    ...
                    J.createEvent
                      ? ((c = J.createEvent('HTMLEvents')), c.initEvent(a, !0, !0))
                      : ((c = J.createEventObject()), (c.eventType = a));
                  for (d in b) o(b, d) && (c[d] = b[d]);
                  if (J.createEvent) J.dispatchEvent(c);
                  else
                    try {
              ...
              B: function() {
                    ...
                    y(
                      ...
                      function(c) {
                        return function(d) {
                          ...
                          for (
                            var f = this, g = ['onload', 'onerror', 'onprogress'], i = 0;
                            i < g.length;
                            i++
                          )
                            a(g[i], f);
                          return (
                            'onreadystatechange' in f && h(f.onreadystatechange)
                              ? y(f, 'onreadystatechange', function(a) {
                ...
                c.xhr &&
                  ...
                  c.dom &&
                    this.b &&
                    (J.addEventListener
                      ? (J.addEventListener('click', b.S('click'), !1),
                        J.addEventListener('keypress', b.U(), !1))
                      : (J.attachEvent('onclick', b.S('click')),
                        J.attachEvent('onkeypress', b.U())));
                var f = I.chrome,
                  g = f && f.app && f.app.runtime,
                  j = !g && I.history && history.pushState;
                if (c.location && j) {
                  var l = I.onpopstate;
              ...
              X: function(a, b, c, d, e, f) {
                var g = (a || '') + ': ' + (b || '');
                if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(g)) {
                  var h;
                  if (
                    (e && e.length
              ...
              Z: function(a) {
                ...
                return (
                  d &&
                    (d.url && (d.url = n(d.url, this.k.maxUrlLength)),
              ...
              $: function(a) {
                for (
                  ...
                  if (
                    ((c = a.values[f]),
                    c.hasOwnProperty('data') && E(c.data) && !m(c.data))
                  ) {
                    d = l({}, c.data);
              ...
              _: function() {
                if (this.c || this.b) {
                  ...
                  return (
                    ...
                    this.b &&
                      (J.location && J.location.href && (a.url = J.location.href),
                      J.referrer &&
                        (a.headers || (a.headers = {}),
              ...
              da: function(a) {
                ...
                return (
                  ...
                  (a.stacktrace || b.stacktrace
                    ? x(a.stacktrace, b.stacktrace)
                    : (!a.exception && !b.exception) || w(a.exception, b.exception))
                );
              },
              ea: function(a) {
                if (!this.ca()) {
                  ...
                  if ('undefined' != typeof a.stack && a.stack) {
                    for (
                      var b,
                        c,
                        e,
                        f = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
