...
For this release's iteration of the migration guide, see the [Migration Guide as per `11.0.0-beta.2`](https://github.com/getsentry/sentry-javascript/blob/11.0.0-beta.2/MIGRATION.md#upgrading-from-10x-to-11x).
...
For this release's iteration of the migration guide, see the [Migration Guide as per `11.0.0-beta.0`](https://github.com/getsentry/sentry-javascript/blob/11.0.0-beta.0/MIGRATION.md#upgrading-from-10x-to-11x).
