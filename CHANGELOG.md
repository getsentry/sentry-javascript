...
- chore(bundler-plugins): Deprecate the `@sentry/bundler-plugins/webpack5` entry point. Use `@sentry/bundler-plugins/webpack` instead; both export the same plugin.
