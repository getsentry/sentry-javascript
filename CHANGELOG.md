...
- **feat(v10/nestjs): Add support for NestJS v12 ([#23729](https://github.com/getsentry/sentry-javascript/pull/23729))**

  `@sentry/nestjs` is now compatible with NestJS v12 applications.
