...
// Fail the app on any SDK warning
...
Sentry.init({
  ...
  // Only the "(tracer provider)" variant opts in; `undefined` keeps the SDK default
...
// Fastify must load after Sentry.init()
...
// External target for propagation tests
const app2 = fastify();
