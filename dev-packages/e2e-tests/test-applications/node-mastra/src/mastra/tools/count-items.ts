...
// Uses the orchestrion-instrumented `dataloader` inside a tool, to prove orchestrion works for a
// non-Mastra package driven through the agent's tool-call flow.
