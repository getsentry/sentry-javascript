...
describe('consola integration', () => {
  ...
  createCjsTests(__dirname, 'scenario-types.mjs', 'instrument.mjs', (createRunner, test) => {
  ...
  createCjsTests(__dirname, 'scenario-args.mjs', 'instrument.mjs', (createRunner, test) => {
  ...
  createCjsTests(__dirname, 'scenario-tags.mjs', 'instrument.mjs', (createRunner, test) => {
  ...
  createCjsTests(__dirname, 'scenario-custom-levels.mjs', 'instrument.mjs', (createRunner, test) => {
  ...
  createCjsTests(__dirname, 'scenario-levels.mjs', 'instrument.mjs', (createRunner, test) => {
  ...
  createCjsTests(__dirname, 'scenario-object-first.mjs', 'instrument.mjs', (createRunner, test) => {
