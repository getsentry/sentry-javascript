    ...
    spans: expect.arrayContaining([
      ...
      expect.objectContaining({
        data: {
          ...
          'vercel.ai.operationId': 'vercel.ai.generateText',
          ...
          'operation.name': 'vercel.ai.generateText',
      ...
      expect.objectContaining({
        data: {
          ...
          'operation.name': 'vercel.ai.generateText.doGenerate',
          'vercel.ai.operationId': 'vercel.ai.generateText.doGenerate',
          'vercel.ai.model.provider': 'mock-provider',
          'vercel.ai.model.id': 'mock-model-id',
          'vercel.ai.settings.maxRetries': 2,
      ...
      expect.objectContaining({
        data: {
          'vercel.ai.operationId': 'vercel.ai.toolCall',
          'gen_ai.tool.call.id': 'call-1',
          'gen_ai.tool.name': 'getWeather',
          'gen_ai.tool.type': 'function',
          'operation.name': 'vercel.ai.toolCall',
