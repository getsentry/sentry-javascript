...
// DO yields a storage-bearing DO segment span and triggering the workflow yields
// a `step-one` segment span. Both only arrive if both classes were auto-wrapped.
